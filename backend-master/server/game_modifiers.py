...
class FlipGrid(GameModifier):
    DESCRIPTION = "Screen Flip: Mirror protocol engaged"

    async def task(self):
        while True:
            logging.debug("Screen flip")
...
class Alien(GameModifier):
    DESCRIPTION = "Translation Error: Alien encoding detected"
...
class TraceStormField(GameModifier):
    DESCRIPTION = "Trace Storm: FBI monitoring rate critical"
...
class VirusStormField(GameModifier):
    DESCRIPTION = "Virus Storm: malware injection rate critical"
